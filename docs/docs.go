        ...
        "/features/{companyID}": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/FeaturePagination"
                        }
                    },
                    "400": {
                        "description": "Invalid request",
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Feature query params",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/FeatureIn"
                        }
                    }
                ],
                "responses": {
