...
type UserSessionJWT struct {
	...
	Roles     []RolesSessionJWT `json:"roles"`
	UserID    uuid.UUID         `json:"user_id"`
}

// RolesSessionJWT represents the structure for storing roles information in JWT.
type RolesSessionJWT struct {
...
// notamment lors de la mise en œuvre de la pagination, où vous devez connaître le nombre
// total d'éléments pour déterminer le nombre total de pages à afficher.
